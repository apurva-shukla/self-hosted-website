*I've always admired the "uses this" pages of people on the internet, here is mine.*

### Hardware

- [2025 M5 16gb Macbook Pro 14"](https://www.apple.com/macbook-pro-14/)
...
- [Mini PC](https://www.ebay.com/sch/i.html?_nkw=n100%20mini%20pc&_sacat=0&_odkw=Cilate%20Mini%20Pc%20Desktop%20Computers&_osacat=0)
...
- [KeyCron K11 Max](https://www.keychron.com/products/keychron-k11-max-qmk-via-wireless-custom-mechanical-keyboard?variant=41140535361625)
  - Switched to this Alice style keyboard from the Magic Keyboard.
  - Took a week to adjust, and now I love how relaxed my shoulders feel. Surprisingly, I still type fine on laptops.
  - Best part: QMK programmability and a decent thock sound. I've set up a few layers and a few shortcuts that help me with Yabai
  - Wish QMK was wireless. Plugging in to customize is a hassle, so I do it less.
- [Apple Magic Mouse 3](https://www.apple.com/magic-mouse-3/)
  - The only bit I like about the mouse is the breadth of shortcuts I can trigger with BetterTouchTool. 
  - Strongly considering giving MX Master 3S a try.
...
- [BetterTouchTool](https://folivora.ai/bettertouchtool)
  ...
  - I also use BTT to use Capslock as my Hyper key. At the moment, I launch almost apps using it (e.g, CAPS + C = Chrome; CAPS + S = Slack)
